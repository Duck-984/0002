/*
# Create create_order_with_stock function

Atomically creates an order and deducts stock from products in a single transaction.
Prevents overselling by checking stock >= quantity before deducting.
*/
